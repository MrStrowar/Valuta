...
public class MyListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            holder.name = (TextView) v.findViewById(R.id.nameID);
            holder.abbreviation = ((TextView) v.findViewById(R.id.abbreviationID));
            holder.stolish = (TextView) v.findViewById(R.id.stolishID);
            v.setTag(holder);
        }
        ...
        holder.stolish.setText(v.getResources().getString(dataFlags.getStolishID()));
